                                ...
                                {(day.subsections || []).map((task, idx) => {
                                   ...
                                   return (
                                     <div
                                       ...
                                       className={`flex items-center justify-between px-3 py-2 rounded-lg hover:opacity-80 transition-all ${isDragging ? 'cursor-grabbing opacity-50' : 'cursor-grab'} ${isDragOver ? 'border-2 border-dashed border-cyan-400' : ''}`}
